...
export function createOffice(teamSize = 6): OfficeScene {
  ...
  const locations: NamedLocation[] = [
    { name: 'desk_0', position: [3.5, 0, 2.0], seatDirection: [0, 0, 1] },
    { name: 'desk_1', position: [7.5, 0, 2.0], seatDirection: [0, 0, 1] },
    { name: 'desk_2', position: [15.5, 0, 2.0], seatDirection: [0, 0, 1] },
    { name: 'desk_3', position: [19.5, 0, 2.0], seatDirection: [0, 0, 1] },
